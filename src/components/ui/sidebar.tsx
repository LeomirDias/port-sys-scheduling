    ...
    >
      ...
      >
        <div
          ...
          className="bg-transparent group-data-[variant=floating]:border-transparent flex h-full w-full flex-col group-data-[variant=floating]:rounded-none p-2 group-data-[variant=floating]:border group-data-[variant=floating]:shadow-none"
        >
          {children}
        </div>
      </div>
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "hover:bg-primary mt-1 ml-1 size-10 transition-colors duration-200 hover:text-white",
        className,
      )}
      onClick={(event) => {
        onClick?.(event);
...
function SidebarMenu({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn(
        "flex w-full min-w-0 flex-col gap-1 group-data-[state=collapsed]:items-center",
        className,
      )}
      {...props}
    />
...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={cn(
        "group/menu-item relative w-full group-data-[state=collapsed]:flex group-data-[state=collapsed]:justify-center",
        className,
      )}
      {...props}
    />
